...
unsafe fn create_vao(vertices: &Vec<f32>, indices: &Vec<u32>) -> u32 {
	...
	let n: gl::types::GLsizei = 5;
	gl::GenVertexArrays(n, &mut vao_id);
	gl::BindVertexArray(vao_id);
	println!("VAO ID: {}", vao_id);

	// * Generate a VBO and bind it
	let mut vbo_id_one: gl::types::GLuint = 0;
	gl::GenBuffers(n, &mut vbo_id_one);
	gl::BindBuffer(gl::ARRAY_BUFFER, vbo_id_one);
	println!("VBO ID: {}", vbo_id_one);
	...
	let mut vbo_id_two: gl::types::GLuint = 0;
	gl::GenBuffers(n, &mut vbo_id_two);
	gl::BindBuffer(gl::ELEMENT_ARRAY_BUFFER, vbo_id_two);
